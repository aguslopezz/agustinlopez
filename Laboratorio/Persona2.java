...
public class Persona2 {
    ...
    public void setDatoString(String dataType, String datoString){
        if (dataType == "nombre"){
            nombre = datoString;
        }

        if (dataType == "Direccion"){
            direccion = datoString;
        }
    }

    public void setDatoInt(String dataType, int datoInt) {
        if (dataType == "edad") {
            edad = datoInt;
        }
